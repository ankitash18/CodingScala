...
object Aggregations extends App{
  ...
  // counting
  val genresCountDF = moviesDF.select(count(col("Major_Genre")))//.show() // all the values except null
...
//countByGenreDF.show()
  ...
  moviesDF
    ...
    .orderBy(col("Avg_Rating").desc_nulls_last) //in desenign order
    .show()


//ahhrehation/grouping are wide transformaiton
  //shuffles
  //one or more input transformaiton - one or more output transformaiton
}
